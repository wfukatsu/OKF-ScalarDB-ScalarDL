...
resource: https://scalardb-community.scalar-labs.com/docs/3.11/scalardb-samples/multi-storage-transaction-sample/README/
tags:
- scalardb-community
- v3.11
- phase:implement
...
- id: docs-scalardb-community
  resource: https://github.com/scalar-labs/docs-scalardb-community/blob/71d199cb0df1c638bd7e305b64fa09fc7236e5c4/versioned_docs/version-3.11/scalardb-samples/multi-storage-transaction-sample/README.mdx
...
![Overview](https://scalardb-community.scalar-labs.com/docs/3.11/scalardb-samples/multi-storage-transaction-sample/images/overview.png)
...
![ERD](https://scalardb-community.scalar-labs.com/docs/3.11/scalardb-samples/multi-storage-transaction-sample/images/ERD.png)
