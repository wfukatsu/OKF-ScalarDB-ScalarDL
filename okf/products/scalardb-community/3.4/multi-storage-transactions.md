...
description: Scalar DB transactions can span multiple storages/databases while preserving ACID property with a feature called Multi-storage Transactions. This documentation explains the feature briefly.
resource: https://scalardb-community.scalar-labs.com/docs/3.4/multi-storage-transactions/
tags:
- scalardb-community
- v3.4
- phase:implement
...
- id: docs-scalardb-community
  resource: https://github.com/scalar-labs/docs-scalardb-community/blob/71d199cb0df1c638bd7e305b64fa09fc7236e5c4/versioned_docs/version-3.4/multi-storage-transactions.mdx
