...
description: Scalar DB also supports two-phase commit style transactions called Two-phase Commit Transactions. With Two-phase Commit Transactions, you can execute a transaction that spans multiple processes/applications (e.g., Microservices).
resource: https://scalardb-community.scalar-labs.com/docs/3.4/two-phase-commit-transactions/
tags:
- scalardb-community
- v3.4
- phase:implement
...
- id: docs-scalardb-community
  resource: https://github.com/scalar-labs/docs-scalardb-community/blob/71d199cb0df1c638bd7e305b64fa09fc7236e5c4/versioned_docs/version-3.4/two-phase-commit-transactions.mdx
