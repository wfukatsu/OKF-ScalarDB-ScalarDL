---
type: Reference
title: Database schema in Scalar DB
description: Scalar DB has its own data model and schema, that maps to the implementation specific data model and schema. Also, it stores internal metadata for managing transaction logs and statuses. This document briefly explains the Scalar DB data...
resource: https://scalardb-community.scalar-labs.com/docs/3.4/schema/
tags:
- scalardb-community
- v3.4
- phase:implement
...
- id: docs-scalardb-community
  resource: https://github.com/scalar-labs/docs-scalardb-community/blob/71d199cb0df1c638bd7e305b64fa09fc7236e5c4/versioned_docs/version-3.4/schema.mdx
