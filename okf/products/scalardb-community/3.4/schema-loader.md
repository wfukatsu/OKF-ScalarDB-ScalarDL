...
description: Scalar DB Schema Loader creates and deletes Scalar DB schemas (namespaces and tables) on the basis of a provided schema file. Also, it automatically adds the Scalar DB transaction metadata (used in the Consensus Commit protocol) to the...
resource: https://scalardb-community.scalar-labs.com/docs/3.4/schema-loader/
tags:
- scalardb-community
- v3.4
- phase:implement
...
- id: docs-scalardb-community
  resource: https://github.com/scalar-labs/docs-scalardb-community/blob/71d199cb0df1c638bd7e305b64fa09fc7236e5c4/versioned_docs/version-3.4/schema-loader.mdx
