---
type: Tutorial
title: Getting Started with Scalar DB
description: Here we assume Oracle JDK 8 and the underlying storage/database such as Cassandra are properly configured. If you haven't done it, please configure them first by following this.
resource: https://scalardb-community.scalar-labs.com/docs/3.4/getting-started-with-scalardb/
tags:
- scalardb-community
- v3.4
- phase:implement
...
- id: docs-scalardb-community
  resource: https://github.com/scalar-labs/docs-scalardb-community/blob/71d199cb0df1c638bd7e305b64fa09fc7236e5c4/versioned_docs/version-3.4/getting-started-with-scalardb.mdx
...
[`ElectronicMoneyWithStorage.java`](https://scalardb-community.scalar-labs.com/docs/3.4/getting-started/src/main/java/sample/ElectronicMoneyWithStorage.java)
