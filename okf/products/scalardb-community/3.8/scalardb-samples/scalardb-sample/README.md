...
title: Create a Sample Application That Uses ScalarDB
description: This tutorial describes how to create a sample e-commerce application by using ScalarDB.
resource: https://scalardb-community.scalar-labs.com/docs/3.8/scalardb-samples/scalardb-sample/README/
tags:
- scalardb-community
- v3.8
- phase:implement
...
version: '3.8'
doc_id: scalardb-samples/scalardb-sample/README
...
- id: docs-scalardb-community
  resource: https://github.com/scalar-labs/docs-scalardb-community/blob/71d199cb0df1c638bd7e305b64fa09fc7236e5c4/versioned_docs/version-3.8/scalardb-samples/scalardb-sample/README.mdx
...
To reference the sample application source code, see [src/main/java/sample/Sample.java](https://scalardb-community.scalar-labs.com/docs/3.8/scalardb-samples/scalardb-sample/src/main/java/sample/Sample.java).
...
Cassandra is already configured for the sample application, as shown in [`database.properties`](https://scalardb-community.scalar-labs.com/docs/3.8/scalardb-samples/scalardb-sample/database.properties).
...
The database schema (the method in which the data will be organized) for the sample application has already been defined in [`schema.json`](https://scalardb-community.scalar-labs.com/docs/3.8/scalardb-samples/scalardb-sample/schema.json).
...
As shown in [`schema.json`](https://scalardb-community.scalar-labs.com/docs/3.8/scalardb-samples/scalardb-sample/schema.json) for the sample application, all the tables are created in the `sample` namespace.
...
![ERD](https://scalardb-community.scalar-labs.com/docs/3.8/scalardb-samples/scalardb-sample/images/ERD.png)
