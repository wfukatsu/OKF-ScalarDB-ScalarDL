...
resource: https://scalardb-community.scalar-labs.com/docs/3.12/scalardb-analytics-postgresql/getting-started/
tags:
- scalardb-community
- v3.12
- phase:implement
...
- id: docs-scalardb-community
  resource: https://github.com/scalar-labs/docs-scalardb-community/blob/71d199cb0df1c638bd7e305b64fa09fc7236e5c4/versioned_docs/version-3.12/scalardb-analytics-postgresql/getting-started.mdx
...
![Multi-storage overview](https://scalardb-community.scalar-labs.com/docs/3.12/scalardb-analytics-postgresql/images/multi-storage-overview.png)
...
![Imported schema](https://scalardb-community.scalar-labs.com/docs/3.12/scalardb-analytics-postgresql/images/imported-schema.png)
