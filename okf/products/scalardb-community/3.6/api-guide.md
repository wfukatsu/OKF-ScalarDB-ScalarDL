...
resource: https://scalardb-community.scalar-labs.com/docs/3.6/api-guide/
tags:
- scalardb-community
- v3.6
- phase:implement
...
- id: docs-scalardb-community
  resource: https://github.com/scalar-labs/docs-scalardb-community/blob/71d199cb0df1c638bd7e305b64fa09fc7236e5c4/versioned_docs/version-3.6/api-guide.mdx
...
Before executing transactional CRUD operations, you need to start a transaction.
...
If an error occurs when executing a transaction, you can abort the transaction.
