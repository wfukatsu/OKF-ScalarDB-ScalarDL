...
resource: https://scalardb-community.scalar-labs.com/docs/3.6/getting-started-with-scalardb/
tags:
- scalardb-community
- v3.6
- phase:implement
...
- id: docs-scalardb-community
  resource: https://github.com/scalar-labs/docs-scalardb-community/blob/71d199cb0df1c638bd7e305b64fa09fc7236e5c4/versioned_docs/version-3.6/getting-started-with-scalardb.mdx
...
To see the source code for the electronic money application used in this tutorial, see [`ElectronicMoney.java`](https://scalardb-community.scalar-labs.com/docs/3.6/getting-started/src/main/java/sample/ElectronicMoney.java).
