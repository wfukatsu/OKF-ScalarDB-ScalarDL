...
resource: https://scalardb-community.scalar-labs.com/docs/latest/schema-loader/
tags:
- scalardb-community
- v3.13
- phase:implement
...
- id: docs-scalardb-community
  resource: https://github.com/scalar-labs/docs-scalardb-community/blob/71d199cb0df1c638bd7e305b64fa09fc7236e5c4/docs/schema-loader.mdx
...
- The `transaction` field indicates whether the table is for transactions or not.
  ...
  - If you set the `transaction` field to `false`, this tool creates a table without any transaction metadata (that is, for a table with [Storage API](https://scalardb-community.scalar-labs.com/docs/latest/storage-abstraction/)).
