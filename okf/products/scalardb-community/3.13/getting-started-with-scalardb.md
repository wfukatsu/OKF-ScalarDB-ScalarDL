...
resource: https://scalardb-community.scalar-labs.com/docs/latest/getting-started-with-scalardb/
tags:
- scalardb-community
- v3.13
- phase:implement
...
- id: docs-scalardb-community
  resource: https://github.com/scalar-labs/docs-scalardb-community/blob/71d199cb0df1c638bd7e305b64fa09fc7236e5c4/docs/getting-started-with-scalardb.mdx
...
![ERD](https://scalardb-community.scalar-labs.com/docs/latest/images/getting-started-ERD.png)
