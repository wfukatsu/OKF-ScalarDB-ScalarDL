...
resource: https://scalardb-community.scalar-labs.com/docs/3.9/scalardb-server/
tags:
- scalardb-community
- v3.9
- phase:operate
...
- id: docs-scalardb-community
  resource: https://github.com/scalar-labs/docs-scalardb-community/blob/71d199cb0df1c638bd7e305b64fa09fc7236e5c4/versioned_docs/version-3.9/scalardb-server.mdx
...
- [ScalarDB Server Sample](https://scalardb-community.scalar-labs.com/docs/3.9/scalardb-samples/scalardb-server-sample/README/)

Please also see the following documents to learn how to deploy ScalarDB Server:

- [Deploy ScalarDB Server on AWS](https://scalardb-community.scalar-labs.com/docs/3.9/scalar-kubernetes/ManualDeploymentGuideScalarDBServerOnEKS/)
- [Deploy ScalarDB Server on Azure](https://scalardb-community.scalar-labs.com/docs/3.9/scalar-kubernetes/ManualDeploymentGuideScalarDBServerOnAKS/)
