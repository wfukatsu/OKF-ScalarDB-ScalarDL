...
resource: https://scalardb-community.scalar-labs.com/docs/3.5/scalardb-samples/microservice-transaction-sample/README/
tags:
- scalardb-community
- v3.5
- phase:implement
...
- id: docs-scalardb-community
  resource: https://github.com/scalar-labs/docs-scalardb-community/blob/71d199cb0df1c638bd7e305b64fa09fc7236e5c4/versioned_docs/version-3.5/scalardb-samples/microservice-transaction-sample/README.mdx
...
![Overview](https://scalardb-community.scalar-labs.com/docs/3.5/scalardb-samples/microservice-transaction-sample/images/overview.png)
...
The database schema (the method in which the data will be organized) for the sample application has already been defined in [`customer-service-schema.json`](https://scalardb-community.scalar-labs.com/docs/3.5/scalardb-samples/microservice-transaction-sample/customer-service-schema.json) for the Customer Service and [`order-service-schema.json`](https://scalardb-community.scalar-labs.com/docs/3.5/scalardb-samples/microservice-transaction-sample/order-service-schema.json) for the Order Service.
...
To load the schema for [`order-service-schema.json`](https://scalardb-community.scalar-labs.com/docs/3.5/scalardb-samples/microservice-transaction-sample/order-service-schema.json) into Cassandra, run the following command, replacing `<VERSION>` with the version of the ScalarDB Schema Loader that you downloaded:
...
As shown in [`customer-service-schema.json`](https://scalardb-community.scalar-labs.com/docs/3.5/scalardb-samples/microservice-transaction-sample/customer-service-schema.json) for the sample application, all the tables for the Customer Service are created in the `customer_service` namespace.
...
As shown in [`order-service-schema.json`](https://scalardb-community.scalar-labs.com/docs/3.5/scalardb-samples/microservice-transaction-sample/order-service-schema.json) for the sample application, all the tables for the Order Service are created in the `order_service` namespace.
...
![ERD](https://scalardb-community.scalar-labs.com/docs/3.5/scalardb-samples/microservice-transaction-sample/images/ERD.png)
...
![Microservice transaction sequence diagram](https://scalardb-community.scalar-labs.com/docs/3.5/scalardb-samples/microservice-transaction-sample/images/sequence_diagram.png)
...
At first, the Order Service starts a transaction with a two-phase commit interface with `start()` as follows. For reference, see [`OrderService.java`](https://scalardb-community.scalar-labs.com/docs/3.5/scalardb-samples/microservice-transaction-sample/order-service/src/main/java/sample/order/OrderService.java).
