...
resource: https://scalardb-community.scalar-labs.com/docs/3.7/two-phase-commit-transactions/
tags:
- scalardb-community
- v3.7
- phase:implement
...
- id: docs-scalardb-community
  resource: https://github.com/scalar-labs/docs-scalardb-community/blob/71d199cb0df1c638bd7e305b64fa09fc7236e5c4/versioned_docs/version-3.7/two-phase-commit-transactions.mdx
...
Or, for the process or application that starts the transaction to act as Coordinator, you should use the following `start` method:
...
![Sequence diagram for transactions with a two-phase commit interface](https://scalardb-community.scalar-labs.com/docs/3.7/images/two_phase_commit_sequence_diagram.png)
...
![Load balancing for transactions with a two-phase commit interface](https://scalardb-community.scalar-labs.com/docs/3.7/images/two_phase_commit_load_balancing.png)
