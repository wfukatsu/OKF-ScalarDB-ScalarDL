...
description: This document explains how to get started with ScalarDB Analytics with PostgreSQL. We assume that you have already installed ScalarDB Analytics with PostgreSQL and that all required services are running. If you don't have such an...
resource: https://scalardb-community.scalar-labs.com/docs/3.10/scalardb-analytics-postgresql/getting-started/
tags:
- scalardb-community
- v3.10
- phase:implement
...
version: '3.10'
doc_id: scalardb-analytics-postgresql/getting-started
...
- id: docs-scalardb-community
  resource: https://github.com/scalar-labs/docs-scalardb-community/blob/71d199cb0df1c638bd7e305b64fa09fc7236e5c4/versioned_docs/version-3.10/scalardb-analytics-postgresql/getting-started.mdx
...
This command sets up [multiple storage instances](../multi-storage-transactions.md) that consist of DynamoDB, PostgreSQL, and Cassandra. Then, the command creates namespaces for `dynamons`, `postgresns`, and `cassandrans` that are mapped to those storages, creates tables for `dynamons.customer`, `postgresns.orders`, and `cassandrans.lineitem` by using [ScalarDB Schema Loader](../schema-loader.md).

![Multi-storage overview](https://scalardb-community.scalar-labs.com/docs/3.10/scalardb-analytics-postgresql/images/multi-storage-overview.png)
...
![Imported schema](https://scalardb-community.scalar-labs.com/docs/3.10/scalardb-analytics-postgresql/images/imported-schema.png)
