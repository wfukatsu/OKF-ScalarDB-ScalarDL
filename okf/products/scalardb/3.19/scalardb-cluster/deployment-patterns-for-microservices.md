...
resource: https://scalardb.scalar-labs.com/docs/latest/scalardb-cluster/deployment-patterns-for-microservices/
tags:
- scalardb
- v3.19
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/docs/scalardb-cluster/deployment-patterns-for-microservices.mdx
...
![ScalarDB Cluster deployment patterns for microservices.](https://scalardb.scalar-labs.com/docs/latest/scalardb-cluster/images/scalardb-deployment-patterns.png)
