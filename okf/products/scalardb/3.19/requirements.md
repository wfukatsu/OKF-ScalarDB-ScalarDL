...
resource: https://scalardb.scalar-labs.com/docs/latest/requirements/
tags:
- scalardb
- v3.19
- phase:design
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/docs/requirements.mdx
...
| Version           | Spanner (PostgreSQL dialect) |
|:------------------|:--------|
| **ScalarDB 3.19** | ✅       |
| **ScalarDB 3.18** | ✅       |
| **ScalarDB 3.17** | ❌       |
...
ScalarDB works only for [Spanner database with the PostgreSQL dialect](https://docs.cloud.google.com/spanner/docs/create-manage-databases).
...
If you're using Spanner, the following role must be granted:
...
| :------------------------- | :------------- | :------------- |
| 3.19                       | 3.5, 3.4       | 2.13, 2.12     |
| 3.18                       | 3.5, 3.4       | 2.13, 2.12     |
