...
resource: https://scalardb.scalar-labs.com/docs/latest/scalar-kubernetes/AwsMarketplaceGuide/
tags:
- scalardb
- v3.19
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/docs/scalar-kubernetes/AwsMarketplaceGuide.mdx
