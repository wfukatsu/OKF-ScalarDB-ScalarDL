...
resource: https://scalardb.scalar-labs.com/docs/latest/scalardb-analytics/deployment-local/
tags:
- scalardb
- v3.19
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/docs/scalardb-analytics/deployment-local.mdx
...
spec:
  containers:
    - name: analytics-server-cli
      image: ghcr.io/scalar-labs/scalardb-analytics-cli:3.19.0
      command: ['sleep']
      args: ['inf']
  restartPolicy: Never
EOF
