...
resource: https://scalardb.scalar-labs.com/docs/latest/scalardb-analytics/configurations/
tags:
- scalardb
- v3.19
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/docs/scalardb-analytics/configurations.mdx
...
```properties
spark.jars.packages                         com.scalar-labs:scalardb-analytics-spark-all-3.5_2.12:3.19.0
