...
resource: https://scalardb.scalar-labs.com/docs/latest/scalardb-sql/scalardb-sql-status-codes/
tags:
- scalardb
- v3.18
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/docs/scalardb-sql/scalardb-sql-status-codes.mdx
