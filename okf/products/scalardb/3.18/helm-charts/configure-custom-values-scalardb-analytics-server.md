...
resource: https://scalardb.scalar-labs.com/docs/latest/helm-charts/configure-custom-values-scalardb-analytics-server/
tags:
- scalardb
- v3.18
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/docs/helm-charts/configure-custom-values-scalardb-analytics-server.mdx
