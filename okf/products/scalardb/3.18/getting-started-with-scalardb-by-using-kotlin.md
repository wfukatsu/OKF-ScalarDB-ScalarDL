...
resource: https://scalardb.scalar-labs.com/docs/3.18/getting-started-with-scalardb-by-using-kotlin/
tags:
- scalardb
- v3.18
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.18/getting-started-with-scalardb-by-using-kotlin.mdx
...
You can run Spanner Omni in Docker Compose by using the `docker-compose.yml` file in the `scalardb-samples/scalardb-kotlin-sample` directory.
...
The **database.properties** file in the `scalardb-samples/scalardb-kotlin-sample` directory contains database configurations. Please uncomment the properties for Spanner in the **database.properties** file so that the configuration looks as follows:
