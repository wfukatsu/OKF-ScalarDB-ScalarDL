...
resource: https://scalardb.scalar-labs.com/docs/latest/libraries-and-tools/
tags:
- scalardb
- v3.18
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/docs/libraries-and-tools.mdx
