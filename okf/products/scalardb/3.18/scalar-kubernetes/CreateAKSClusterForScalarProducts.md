...
title: Guidelines for creating an AKS cluster for Scalar products
description: 'To create an Azure Kubernetes Service (AKS) cluster for Scalar products, refer to the following:'
resource: https://scalardb.scalar-labs.com/docs/3.18/scalar-kubernetes/CreateAKSClusterForScalarProducts/
tags:
- scalardb
- v3.18
- phase:operate
...
doc_id: scalar-kubernetes/CreateAKSClusterForScalarProducts
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.18/scalar-kubernetes/CreateAKSClusterForScalarProducts.mdx
