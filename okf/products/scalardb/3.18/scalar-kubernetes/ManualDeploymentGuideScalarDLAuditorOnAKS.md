...
resource: https://scalardb.scalar-labs.com/docs/3.18/scalar-kubernetes/ManualDeploymentGuideScalarDLAuditorOnAKS/
tags:
- scalardb
- v3.18
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.18/scalar-kubernetes/ManualDeploymentGuideScalarDLAuditorOnAKS.mdx
...
* Use different Azure accounts (most recommended way)
  ...
  ![image](https://scalardb.scalar-labs.com/docs/3.18/scalar-kubernetes/images/png/AKS_ScalarDL_Auditor_Multi_Account.drawio.png)

* Use different Azure Virtual Networks (VNets) (second recommended way)

  ![image](https://scalardb.scalar-labs.com/docs/3.18/scalar-kubernetes/images/png/AKS_ScalarDL_Auditor_Multi_VNet.drawio.png)

* Use different namespaces (third recommended way)

  ![image](https://scalardb.scalar-labs.com/docs/3.18/scalar-kubernetes/images/png/AKS_ScalarDL_Auditor_Multi_Namespace.drawio.png)
