...
title: Guidelines for creating an AKS cluster for ScalarDL Ledger and ScalarDL Auditor
description: This document explains the requirements and recommendations for creating an Azure Kubernetes Service (AKS) cluster for ScalarDL Ledger and ScalarDL Auditor deployment. For details on how to deploy ScalarDL Ledger and ScalarDL Auditor on an...
resource: https://scalardb.scalar-labs.com/docs/3.18/scalar-kubernetes/CreateAKSClusterForScalarDLAuditor/
tags:
- scalardb
- v3.18
- phase:operate
...
doc_id: scalar-kubernetes/CreateAKSClusterForScalarDLAuditor
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.18/scalar-kubernetes/CreateAKSClusterForScalarDLAuditor.mdx
