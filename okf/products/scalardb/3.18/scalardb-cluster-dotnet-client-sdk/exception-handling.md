...
resource: https://scalardb.scalar-labs.com/docs/3.18/scalardb-cluster-dotnet-client-sdk/exception-handling/
tags:
- scalardb
- v3.18
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/4fa644f40396f8d8f5d3d0d90c217b77ea0e70d1/versioned_docs/version-3.18/scalardb-cluster-dotnet-client-sdk/exception-handling.mdx
...
The Transaction API is used in this example, but exceptions can be handled in the same way when using the SQL API or `ScalarDbContext`.
