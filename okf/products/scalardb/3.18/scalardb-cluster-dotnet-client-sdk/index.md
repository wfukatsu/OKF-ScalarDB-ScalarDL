...
title: ScalarDB 3.18 — Scalardb Cluster Dotnet Client Sdk
description: Directory listing for the `scalardb-cluster-dotnet-client-sdk` section of the ScalarDB 3.18 documentation.
resource: https://scalardb.scalar-labs.com/docs/latest/scalardb-cluster-dotnet-client-sdk/
tags:
- scalardb
- v3.18
- index
...
ScalarDB 3.18 documentation under `scalardb-cluster-dotnet-client-sdk/`.

Section overview: [ScalarDB Cluster .NET Client SDK Overview](./section-home.md)

## Concepts

- [Exception Handling in the ScalarDB Cluster .NET Client SDK](./exception-handling.md) — When executing a transaction, you will also need to handle exceptions properly.
- [Getting Started with ASP.NET Core and Dependency Injection in the ScalarDB Cluster .NET Client SDK](./getting-started-with-aspnet-and-di.md) — The ScalarDB Cluster .NET Client SDK supports dependency injection (DI) in frameworks like ASP.NET Core.
...
- [ScalarDB Cluster .NET Client SDK Reference](./common-reference.md) — This reference provides details on how the ScalarDB Cluster .NET Client SDK works.
