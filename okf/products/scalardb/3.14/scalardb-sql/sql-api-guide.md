...
resource: https://scalardb.scalar-labs.com/docs/3.14/scalardb-sql/sql-api-guide/
tags:
- scalardb
- v3.14
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.14/scalardb-sql/sql-api-guide.mdx
...
`Statement` objects can be built by `StatementBuilder` that has factory methods for corresponding SQLs. For more details, see the [`StatementBuilder`](https://javadoc.io/static/com.scalar-labs/scalardb-sql/3.14.6/com/scalar/db/sql/statement/builder/StatementBuilder.html) page in the Javadoc and [ScalarDB SQL Grammar](./grammar.md).
...
For more details, see the [`ColumnDefinition`](https://javadoc.io/static/com.scalar-labs/scalardb-sql/3.14.6/com/scalar/db/sql/ColumnDefinition.html) page in the Javadoc.
...
For more details, see the [`Record`](https://javadoc.io/static/com.scalar-labs/scalardb-sql/3.14.6/com/scalar/db/sql/Record.html) page of the Javadoc.
...
For more details, see the [`PreparedStatement`](https://javadoc.io/static/com.scalar-labs/scalardb-sql/3.14.6/com/scalar/db/sql/PreparedStatement.html) page of the Javadoc.
...
For more details, see the [`Metadata`](https://javadoc.io/static/com.scalar-labs/scalardb-sql/3.14.6/com/scalar/db/sql/metadata/Metadata.html) page of the Javadoc.

## References

- [ScalarDB SQL Grammar](./grammar.md)
- [Two-phase Commit Transactions](../two-phase-commit-transactions.md)
- [Javadoc for ScalarDB SQL](https://javadoc.io/doc/com.scalar-labs/scalardb-sql/3.14.6/index.html)
