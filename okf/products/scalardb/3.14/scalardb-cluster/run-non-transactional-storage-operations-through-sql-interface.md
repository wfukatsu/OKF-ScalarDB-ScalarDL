...
resource: https://scalardb.scalar-labs.com/docs/3.14/scalardb-cluster/run-non-transactional-storage-operations-through-sql-interface/
tags:
- scalardb
- v3.14
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.14/scalardb-cluster/run-non-transactional-storage-operations-through-sql-interface.mdx
...
```gradle
dependencies {
    implementation 'com.scalar-labs:scalardb-sql:3.14.6'
    implementation 'com.scalar-labs:scalardb-cluster-java-client-sdk:3.14.6'
}
```
...
- [Javadoc](https://javadoc.io/doc/com.scalar-labs/scalardb-sql/3.14.6/index.html)
