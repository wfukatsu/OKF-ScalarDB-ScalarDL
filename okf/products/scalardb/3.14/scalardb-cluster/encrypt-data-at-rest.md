...
resource: https://scalardb.scalar-labs.com/docs/3.14/scalardb-cluster/encrypt-data-at-rest/
tags:
- scalardb
- v3.14
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.14/scalardb-cluster/encrypt-data-at-rest.mdx
...
- Encrypted columns are stored in the underlying database as the BLOB type, so encrypted columns that are larger than the maximum size of the BLOB type cannot be stored. For the maximum size of the BLOB type, see [Data-type mapping between ScalarDB and other databases](../schema-loader.md#data-type-mapping-between-scalardb-and-other-databases).
