...
title: How to install Scalar products through Azure Marketplace
description: Scalar products are currently not available in Azure Marketplace. For details on other ways to get the container images of Scalar products, please see How to get the container images of Scalar products.
resource: https://scalardb.scalar-labs.com/docs/3.14/scalar-kubernetes/AzureMarketplaceGuide/
tags:
- scalardb
- v3.14
- phase:operate
...
doc_id: scalar-kubernetes/AzureMarketplaceGuide
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.14/scalar-kubernetes/AzureMarketplaceGuide.mdx
