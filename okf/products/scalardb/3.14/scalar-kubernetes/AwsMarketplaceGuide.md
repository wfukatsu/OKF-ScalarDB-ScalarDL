...
resource: https://scalardb.scalar-labs.com/docs/3.14/scalar-kubernetes/AwsMarketplaceGuide/
tags:
- scalardb
- v3.14
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.14/scalar-kubernetes/AwsMarketplaceGuide.mdx
...
For more details on the configurations, see [Configure a Custom Values File for ScalarDB Analytics Server](https://scalardb.scalar-labs.com/docs/3.14/helm-charts/configure-custom-values-scalardb-analytics-server/).
