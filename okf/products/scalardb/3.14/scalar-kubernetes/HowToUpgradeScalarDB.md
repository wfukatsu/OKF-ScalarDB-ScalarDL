...
resource: https://scalardb.scalar-labs.com/docs/3.14/scalar-kubernetes/HowToUpgradeScalarDB/
tags:
- scalardb
- v3.14
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.14/scalar-kubernetes/HowToUpgradeScalarDB.mdx
...
The method for upgrading to a patch version is the same as for upgrading to a minor version. For details on how to upgrade, see the [Upgrade to a minor version](https://scalardb.scalar-labs.com/docs/3.14/scalar-kubernetes/?versions=upgrade-minor-version) tab.
