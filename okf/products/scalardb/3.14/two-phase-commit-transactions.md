...
resource: https://scalardb.scalar-labs.com/docs/3.14/two-phase-commit-transactions/
tags:
- scalardb
- v3.14
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.14/two-phase-commit-transactions.mdx
...
![Sequence diagram for transactions with a two-phase commit interface](https://scalardb.scalar-labs.com/docs/3.14/images/two_phase_commit_sequence_diagram.png)
...
![Load balancing for transactions with a two-phase commit interface](https://scalardb.scalar-labs.com/docs/3.14/images/two_phase_commit_load_balancing.png)
