...
resource: https://scalardb.scalar-labs.com/docs/3.14/scalardb-analytics-postgresql/getting-started/
tags:
- scalardb
- v3.14
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.14/scalardb-analytics-postgresql/getting-started.mdx
...
![Multi-storage overview](https://scalardb.scalar-labs.com/docs/3.14/scalardb-analytics-postgresql/images/multi-storage-overview.png)
...
![Imported schema](https://scalardb.scalar-labs.com/docs/3.14/scalardb-analytics-postgresql/images/imported-schema.png)
