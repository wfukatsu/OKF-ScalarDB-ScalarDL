...
resource: https://scalardb.scalar-labs.com/docs/3.14/scalardb-samples/scalardb-analytics-spark-sample/README/
tags:
- scalardb
- v3.14
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.14/scalardb-samples/scalardb-analytics-spark-sample/README.mdx
