...
resource: https://scalardb.scalar-labs.com/docs/3.14/helm-charts/getting-started-logging/
tags:
- scalardb
- v3.14
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.14/helm-charts/getting-started-logging.mdx
...
1. Get the sample file [scalar-loki-stack-custom-values.yaml](https://scalardb.scalar-labs.com/docs/3.14/helm-charts/conf/scalar-loki-stack-custom-values.yaml) for the `loki-stack` helm chart.
