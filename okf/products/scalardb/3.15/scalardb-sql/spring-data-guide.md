...
resource: https://scalardb.scalar-labs.com/docs/3.15/scalardb-sql/spring-data-guide/
tags:
- scalardb
- v3.15
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.15/scalardb-sql/spring-data-guide.mdx
...
![Rough overall architecture of Spring Data JDBC for ScalarDB](https://scalardb.scalar-labs.com/docs/3.15/scalardb-sql/images/spring_data_ingegration_overall_arch.png)
...
This value follows the ScalarDB JDBC connection URL configuration. For more information, see [ScalarDB JDBC Guide](./jdbc-guide.md) and [ScalarDB Cluster SQL client configurations](../scalardb-cluster/developer-guide-for-scalardb-cluster-with-java-api.md#scalardb-cluster-sql-client-configurations).
...
- [Javadoc for Spring Data JDBC for ScalarDB](https://javadoc.io/doc/com.scalar-labs/scalardb-sql-spring-data/3.15.9/index.html)
