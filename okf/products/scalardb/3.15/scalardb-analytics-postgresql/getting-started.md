...
resource: https://scalardb.scalar-labs.com/docs/3.15/scalardb-analytics-postgresql/getting-started/
tags:
- scalardb
- v3.15
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.15/scalardb-analytics-postgresql/getting-started.mdx
...
![Multi-storage overview](https://scalardb.scalar-labs.com/docs/3.15/scalardb-analytics-postgresql/images/multi-storage-overview.png)
...
![Imported schema](https://scalardb.scalar-labs.com/docs/3.15/scalardb-analytics-postgresql/images/imported-schema.png)
