...
resource: https://scalardb.scalar-labs.com/docs/3.15/helm-charts/getting-started-logging/
tags:
- scalardb
- v3.15
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.15/helm-charts/getting-started-logging.mdx
...
1. Get the sample file [scalar-loki-stack-custom-values.yaml](https://scalardb.scalar-labs.com/docs/3.15/helm-charts/conf/scalar-loki-stack-custom-values.yaml) for the `loki-stack` helm chart.
