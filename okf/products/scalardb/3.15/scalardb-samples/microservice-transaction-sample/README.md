...
resource: https://scalardb.scalar-labs.com/docs/3.15/scalardb-samples/microservice-transaction-sample/README/
tags:
- scalardb
- v3.15
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.15/scalardb-samples/microservice-transaction-sample/README.mdx
...
![Overview](https://scalardb.scalar-labs.com/docs/3.15/scalardb-samples/microservice-transaction-sample/images/overview.png)
...
![ERD](https://scalardb.scalar-labs.com/docs/3.15/scalardb-samples/microservice-transaction-sample/images/ERD.png)
...
![Microservice transaction sequence diagram](https://scalardb.scalar-labs.com/docs/3.15/scalardb-samples/microservice-transaction-sample/images/sequence_diagram.png)
