...
resource: https://scalardb.scalar-labs.com/docs/3.15/overview/
tags:
- scalardb
- v3.15
- phase:design
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.15/overview.mdx
...
![How ScalarDB simplifies complex data management architecture.](https://scalardb.scalar-labs.com/docs/3.15/images/scalardb.png)
