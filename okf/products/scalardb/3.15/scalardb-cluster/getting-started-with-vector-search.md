...
resource: https://scalardb.scalar-labs.com/docs/3.15/scalardb-cluster/getting-started-with-vector-search/
tags:
- scalardb
- v3.15
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.15/scalardb-cluster/getting-started-with-vector-search.mdx
...
```gradle
dependencies {
  implementation 'com.scalar-labs:scalardb-cluster-embedding-java-client-sdk:3.15.9'
}
```
...
- [Javadoc](https://javadoc.io/doc/com.scalar-labs/scalardb-cluster-embedding-java-client-sdk/3.15.9/index.html)
