...
resource: https://scalardb.scalar-labs.com/docs/3.15/scalardb-cluster/scalardb-cluster-configurations/
tags:
- scalardb
- v3.15
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.15/scalardb-cluster/scalardb-cluster-configurations.mdx
...
| Name                          | Description                                                         | Default  |
|-------------------------------|---------------------------------------------------------------------|----------|
| `scalar.db.embedding.enabled` | Whether the embedding feature is enabled.                           | `false`  |
| `scalar.db.embedding.stores`  | Comma-separated list of embedding store names that you want to use. | empty    |
| `scalar.db.embedding.models`  | Comma-separated list of embedding model names that you want to use. | empty    |
...
| Name                                           | Description                 | Default |
|------------------------------------------------|-----------------------------|---------|
| `scalar.db.embedding.stores.<STORE_NAME>.type` | Must be set to `in-memory`. | N/A     |
...
| Name                                                                              | Description                                                                                         | Default |
|-----------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|---------|
| `scalar.db.embedding.stores.<STORE_NAME>.type`                                    | Must be set to `opensearch`.                                                                        | N/A     |
| `scalar.db.embedding.stores.<STORE_NAME>.opensearch.server_url`                   | OpenSearch server URL.                                                                              | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.opensearch.index_name`                   | OpenSearch index name.                                                                              | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.opensearch.api_key` (optional)           | OpenSearch API key for authentication.                                                              | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.opensearch.user_name` (optional)         | OpenSearch username for authentication.                                                             | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.opensearch.password` (optional)          | OpenSearch password for authentication.                                                             | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.opensearch.service_name` (AWS only)      | AWS signing service name. Either `es` (Amazon OpenSearch) or `aoss` (Amazon OpenSearch Serverless). | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.opensearch.region` (AWS only)            | AWS region for signing requests.                                                                    | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.opensearch.access_key_id` (AWS only)     | AWS access key ID.                                                                                  | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.opensearch.secret_access_key` (AWS only) | AWS secret access key.                                                                              | empty   |
...
| Name                                                                        | Description                                     | Default |
|-----------------------------------------------------------------------------|-------------------------------------------------|---------|
| `scalar.db.embedding.stores.<STORE_NAME>.type`                              | Must be set to `azure-cosmos-nosql`.            | N/A     |
| `scalar.db.embedding.stores.<STORE_NAME>.azure-cosmos-nosql.endpoint`       | Azure Cosmos DB endpoint URL.                   | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.azure-cosmos-nosql.key`            | Master key or read-only key for authentication. | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.azure-cosmos-nosql.database_name`  | Azure Cosmos DB database name.                  | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.azure-cosmos-nosql.container_name` | Azure Cosmos DB container name.                 | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.azure-cosmos-nosql.dimensions`     | Dimensions of the embeddings.                   | `1536`  |
...
| Name                                                                 | Description                                                                               | Default |
|----------------------------------------------------------------------|-------------------------------------------------------------------------------------------|---------|
| `scalar.db.embedding.stores.<STORE_NAME>.type`                       | Must be set to `azure-ai-search`.                                                         | N/A     |
| `scalar.db.embedding.stores.<STORE_NAME>.azure-ai-search.endpoint`   | Azure AI Search endpoint URL.                                                             | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.azure-ai-search.api_key`    | Azure AI Search API key.                                                                  | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.azure-ai-search.index_name` | Name of the index to be used. If no index is provided, a default index name will be used. | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.azure-ai-search.dimensions` | Dimensions of the embeddings.                                                             | `1536`  |
...
| Name                                                          | Description                   | Default |
|---------------------------------------------------------------|-------------------------------|---------|
| `scalar.db.embedding.stores.<STORE_NAME>.type`                | Must be set to `pgvector`.    | N/A     |
| `scalar.db.embedding.stores.<STORE_NAME>.pgvector.host`       | Database host.                | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.pgvector.port`       | Database port.                | `5432`  |
| `scalar.db.embedding.stores.<STORE_NAME>.pgvector.user`       | Database user.                | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.pgvector.password`   | Database password.            | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.pgvector.database`   | Database name.                | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.pgvector.table`      | Table name.                   | empty   |
| `scalar.db.embedding.stores.<STORE_NAME>.pgvector.dimensions` | Dimensions of the embeddings. | `1536`  |
...
| Name                                           | Description                  | Default |
|------------------------------------------------|------------------------------|---------|
| `scalar.db.embedding.models.<MODEL_NAME>.type` | Must be set to `in-process`. | N/A     |
...
| Name                                                                      | Description                                                                        | Default |
|---------------------------------------------------------------------------|------------------------------------------------------------------------------------|---------|
| `scalar.db.embedding.models.<MODEL_NAME>.type`                            | Must be set to `bedrock-titan`.                                                    | N/A     |
| `scalar.db.embedding.models.<MODEL_NAME>.bedrock-titan.region`            | AWS region for signing requests.                                                   | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.bedrock-titan.access_key_id`     | AWS access key ID.                                                                 | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.bedrock-titan.secret_access_key` | AWS secret access key.                                                             | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.bedrock-titan.model`             | Model name. Either `amazon.titan-embed-text-v1` or `amazon.titan-embed-text-v2:0`. | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.bedrock-titan.dimensions`        | Dimensions of the embeddings.                                                      | empty   |
...
| Name                                                                    | Description                      | Default |
|-------------------------------------------------------------------------|----------------------------------|---------|
| `scalar.db.embedding.models.<MODEL_NAME>.type`                          | Must be set to `azure-open-ai`.  | N/A     |
| `scalar.db.embedding.models.<MODEL_NAME>.azure-open-ai.endpoint`        | Azure OpenAI endpoint URL.       | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.azure-open-ai.api_key`         | Azure OpenAI API key.            | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.azure-open-ai.deployment_name` | Deployment name in Azure OpenAI. | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.azure-open-ai.dimensions`      | Dimensions of the embeddings.    | empty   |
...
| Name                                                                      | Description                              | Default |
|---------------------------------------------------------------------------|------------------------------------------|---------|
| `scalar.db.embedding.models.<MODEL_NAME>.type`                            | Must be set to `vertex-ai`.              | N/A     |
| `scalar.db.embedding.models.<MODEL_NAME>.vertex-ai.project`               | Google Cloud project ID.                 | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.vertex-ai.location`              | Google Cloud location.                   | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.vertex-ai.endpoint`              | Endpoint URL.                            | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.vertex-ai.publisher`             | Publisher name.                          | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.vertex-ai.model_name`            | Model name.                              | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.vertex-ai.output_dimensionality` | Output dimensionality of the embeddings. | empty   |
...
| Name                                                                         | Description                   | Default |
|------------------------------------------------------------------------------|-------------------------------|---------|
| `scalar.db.embedding.models.<MODEL_NAME>.type`                               | Must be set to `open-ai`.     | N/A     |
| `scalar.db.embedding.models.<MODEL_NAME>.open-ai.api_key`                    | OpenAI API key.               | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.open-ai.model_name`                 | Model name.                   | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.open-ai.base_url` (optional)        | Base URL for the API.         | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.open-ai.organization_id` (optional) | OpenAI organization ID.       | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.open-ai.dimensions` (optional)      | Dimensions of the embeddings. | empty   |
| `scalar.db.embedding.models.<MODEL_NAME>.open-ai.user` (optional)            | User identifier.              | empty   |
...
| Name                                        | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Default  |
|---------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------|
| `scalar.db.embedding.client.contact_points` | Contact point of the cluster. If you use the `indirect` client mode, specify the IP address of the load balancer in front of your cluster nodes by using the format `indirect:<the load balancer IP address>`. If you use the `direct-kubernetes` client mode, specify the namespace name (optional) and the name of the [endpoint resource](https://kubernetes.io/docs/concepts/services-networking/service/#endpoints) to get the membership information by using the format `direct-kubernetes:<namespace name>/<endpoint name>` or just `direct-kubernetes:<endpoint name>`. If you don't specify the namespace name, the Embedding Client SDK will use the `default` namespace. | empty    |
| `scalar.db.embedding.client.contact_port`   | The port number for contact points.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | `60053`  |
| `scalar.db.embedding.client.store`          | The name of the embedding store to use, as defined in `scalar.db.embedding.stores` on the server.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | empty    |
| `scalar.db.embedding.client.model`          | The name of the embedding model to use, as defined in `scalar.db.embedding.models` on the server.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | empty    |
