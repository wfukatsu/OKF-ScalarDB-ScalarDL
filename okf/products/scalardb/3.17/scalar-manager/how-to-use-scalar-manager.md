...
resource: https://scalardb.scalar-labs.com/docs/3.17/scalar-manager/how-to-use-scalar-manager/
tags:
- scalardb
- v3.17
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.17/scalar-manager/how-to-use-scalar-manager.mdx
...
This guide explains how to use Scalar Manager to monitor, manage, and maintain your ScalarDB deployments.
...
![login-page](https://scalardb.scalar-labs.com/docs/3.17/scalar-manager/images/login-page.png)
...
![my-profile-page](https://scalardb.scalar-labs.com/docs/3.17/scalar-manager/images/my-profile.png)
...
![user-create-page](https://scalardb.scalar-labs.com/docs/3.17/scalar-manager/images/user-create.png)
...
![edit-user-page](https://scalardb.scalar-labs.com/docs/3.17/scalar-manager/images/edit-user.png)
...
![delete-user-page](https://scalardb.scalar-labs.com/docs/3.17/scalar-manager/images/delete-user.png)
...
After logging in, you'll see the main dashboard that helps you monitor and manage your Kubernetes cluster and ScalarDB deployments.
...
The dashboard displays a list of all your ScalarDB deployments grouped by releases. For each row, you'll see the following:

- Namespace name
- Release name
- ScalarDB deployment name and component type
- Pod availability
- Current RPS (requests per second)
...
![release-detail-page](https://scalardb.scalar-labs.com/docs/3.17/scalar-manager/images/release-detail.png)
...
The metrics dashboard is pre-configured with product-specific metrics for ScalarDB. You can:
...
![grafana-dashboard](https://scalardb.scalar-labs.com/docs/3.17/scalar-manager/images/metrics.png)
...
![grafana-logs-dashboard](https://scalardb.scalar-labs.com/docs/3.17/scalar-manager/images/logs.png)
...
For detailed information about pausing and when to use it, see [How to Back Up and Restore Databases Used Through ScalarDB](../backup-restore.md).
...
![execute-pause-page](https://scalardb.scalar-labs.com/docs/3.17/scalar-manager/images/execute-pause.png)
...
![schedule-pause-popup](https://scalardb.scalar-labs.com/docs/3.17/scalar-manager/images/schedule-pause-popup.png)
...
![schedule-pauses-page](https://scalardb.scalar-labs.com/docs/3.17/scalar-manager/images/schedule-pauses.png)
...
![check-pauses-page](https://scalardb.scalar-labs.com/docs/3.17/scalar-manager/images/check-pauses.png)
