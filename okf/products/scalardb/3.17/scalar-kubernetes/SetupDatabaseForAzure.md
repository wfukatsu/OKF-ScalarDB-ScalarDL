...
title: Set up a database for ScalarDB/ScalarDL deployment on Azure
description: This guide explains how to set up a database for ScalarDB/ScalarDL deployment on Azure.
resource: https://scalardb.scalar-labs.com/docs/3.17/scalar-kubernetes/SetupDatabaseForAzure/
tags:
- scalardb
- v3.17
- phase:operate
...
doc_id: scalar-kubernetes/SetupDatabaseForAzure
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.17/scalar-kubernetes/SetupDatabaseForAzure.mdx
