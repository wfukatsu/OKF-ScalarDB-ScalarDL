...
resource: https://scalardb.scalar-labs.com/docs/3.17/scalar-kubernetes/ManualDeploymentGuideScalarDLAuditorOnEKS/
tags:
- scalardb
- v3.17
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.17/scalar-kubernetes/ManualDeploymentGuideScalarDLAuditorOnEKS.mdx
...
* Use different AWS accounts (most recommended way)
  ...
  ![image](https://scalardb.scalar-labs.com/docs/3.17/scalar-kubernetes/images/png/EKS_ScalarDL_Auditor_Multi_Account.drawio.png)

* Use different Amazon Virtual Private Clouds (VPCs) (second recommended way)

  ![image](https://scalardb.scalar-labs.com/docs/3.17/scalar-kubernetes/images/png/EKS_ScalarDL_Auditor_Multi_VPC.drawio.png)

* Use different namespaces (third recommended way)

  ![image](https://scalardb.scalar-labs.com/docs/3.17/scalar-kubernetes/images/png/EKS_ScalarDL_Auditor_Multi_Namespace.drawio.png)
