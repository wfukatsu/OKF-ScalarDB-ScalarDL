...
resource: https://scalardb.scalar-labs.com/docs/3.17/scalar-kubernetes/ManualDeploymentGuideScalarDLAuditorOnAKS/
tags:
- scalardb
- v3.17
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.17/scalar-kubernetes/ManualDeploymentGuideScalarDLAuditorOnAKS.mdx
...
* Use different Azure accounts (most recommended way)
  ...
  ![image](https://scalardb.scalar-labs.com/docs/3.17/scalar-kubernetes/images/png/AKS_ScalarDL_Auditor_Multi_Account.drawio.png)

* Use different Azure Virtual Networks (VNets) (second recommended way)

  ![image](https://scalardb.scalar-labs.com/docs/3.17/scalar-kubernetes/images/png/AKS_ScalarDL_Auditor_Multi_VNet.drawio.png)

* Use different namespaces (third recommended way)

  ![image](https://scalardb.scalar-labs.com/docs/3.17/scalar-kubernetes/images/png/AKS_ScalarDL_Auditor_Multi_Namespace.drawio.png)
