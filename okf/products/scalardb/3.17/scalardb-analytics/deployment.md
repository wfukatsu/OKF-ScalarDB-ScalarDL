...
resource: https://scalardb.scalar-labs.com/docs/3.17/scalardb-analytics/deployment/
tags:
- scalardb
- v3.17
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/4fa644f40396f8d8f5d3d0d90c217b77ea0e70d1/versioned_docs/version-3.17/scalardb-analytics/deployment.mdx
...
For details on how to create a Spark application by using Spark Connect, refer to [Spark Connect application](https://scalardb.scalar-labs.com/docs/3.17/scalardb-analytics/run-analytical-queries.mdx?spark-application-type=spark-connect#develop-a-spark-application).
...
For details on Spark driver applications, refer to [Spark driver application](https://scalardb.scalar-labs.com/docs/3.17/scalardb-analytics/run-analytical-queries.mdx?spark-application-type=spark-driver#develop-a-spark-application).
