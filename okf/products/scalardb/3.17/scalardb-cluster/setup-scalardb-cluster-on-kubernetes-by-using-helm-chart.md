...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.17/scalardb-cluster/setup-scalardb-cluster-on-kubernetes-by-using-helm-chart.mdx
...
```console
SCALAR_DB_CLUSTER_VERSION=3.17.4
