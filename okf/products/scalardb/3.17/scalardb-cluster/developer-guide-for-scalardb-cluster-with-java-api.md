...
resource: https://scalardb.scalar-labs.com/docs/3.17/scalardb-cluster/developer-guide-for-scalardb-cluster-with-java-api/
tags:
- scalardb
- v3.17
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.17/scalardb-cluster/developer-guide-for-scalardb-cluster-with-java-api.mdx
...
![ScalarDB Cluster architecture](https://scalardb.scalar-labs.com/docs/3.17/scalardb-cluster/images/indirect-client-mode.png)
...
![ScalarDB Cluster architecture](https://scalardb.scalar-labs.com/docs/3.17/scalardb-cluster/images/direct-kubernetes-client-mode.png)
...
You can download the Schema Loader for Cluster from [ScalarDB Releases](https://github.com/scalar-labs/scalardb/releases/tag/v3.17.2).
...
```gradle
dependencies {
    implementation 'com.scalar-labs:scalardb-sql-spring-data:3.17.2'
    implementation 'com.scalar-labs:scalardb-cluster-java-client-sdk:3.17.2'
}
```
...
You can download the SQL CLI for Cluster from [ScalarDB Releases](https://github.com/scalar-labs/scalardb/releases/tag/v3.17.2). After downloading the JAR file, you can run the SQL CLI with the following command:

```console
java -jar scalardb-cluster-sql-cli-3.17.2-all.jar --config <PATH_TO_SCALARDB_SQL_PROPERTIES_FILE>
```
...
```console
docker run --rm -it -v <PATH_TO_YOUR_LOCAL_SCALARDB_SQL_PROPERTIES_FILE>:/scalardb-sql.properties ghcr.io/scalar-labs/scalardb-cluster-sql-cli:3.17.2 --config /scalardb-sql.properties
```
...
```console
java -jar scalardb-cluster-sql-cli-3.17.2-all.jar -h
...
* [ScalarDB Cluster Java Client SDK](https://javadoc.io/doc/com.scalar-labs/scalardb-cluster-java-client-sdk/3.17.2/index.html)
* [ScalarDB Cluster Common](https://javadoc.io/doc/com.scalar-labs/scalardb-cluster-common/3.17.2/index.html)
* [ScalarDB Cluster RPC](https://javadoc.io/doc/com.scalar-labs/scalardb-cluster-rpc/3.17.2/index.html)
