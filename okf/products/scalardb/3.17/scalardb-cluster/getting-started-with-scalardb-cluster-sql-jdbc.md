...
resource: https://scalardb.scalar-labs.com/docs/3.17/scalardb-cluster/getting-started-with-scalardb-cluster-sql-jdbc/
tags:
- scalardb
- v3.17
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.17/scalardb-cluster/getting-started-with-scalardb-cluster-sql-jdbc.mdx
