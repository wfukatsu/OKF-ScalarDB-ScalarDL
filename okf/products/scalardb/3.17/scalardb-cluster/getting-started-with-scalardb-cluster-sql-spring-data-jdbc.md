...
resource: https://scalardb.scalar-labs.com/docs/3.17/scalardb-cluster/getting-started-with-scalardb-cluster-sql-spring-data-jdbc/
tags:
- scalardb
- v3.17
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.17/scalardb-cluster/getting-started-with-scalardb-cluster-sql-spring-data-jdbc.mdx
