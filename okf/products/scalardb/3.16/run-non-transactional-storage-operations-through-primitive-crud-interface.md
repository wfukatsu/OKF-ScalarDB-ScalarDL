...
title: Run Non-Transactional Storage Operations Through the Primitive CRUD Interface
description: This page explains how to run non-transactional storage operations through the primitive CRUD interface, also known as the Storage API. This guide assumes that you have an advanced understanding of ScalarDB.
resource: https://scalardb.scalar-labs.com/docs/3.16/run-non-transactional-storage-operations-through-primitive-crud-interface/
tags:
- scalardb
- v3.16
- phase:implement
...
doc_id: run-non-transactional-storage-operations-through-primitive-crud-interface
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.16/run-non-transactional-storage-operations-through-primitive-crud-interface.mdx
...
For details about creation options, see [Creation options](./api-guide.md#creation-options-1).
...
For details about creation options, see [Creation options](./api-guide.md#creation-options-2).
