...
resource: https://scalardb.scalar-labs.com/docs/3.16/scalardb-mcp-server/getting-started-with-scalardb-mcp-server/
tags:
- scalardb
- v3.16
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.16/scalardb-mcp-server/getting-started-with-scalardb-mcp-server.mdx
...
![ScalarDB MCP server architecture](https://scalardb.scalar-labs.com/docs/3.16/images/scalardb-mcp-server-architecture.png)
