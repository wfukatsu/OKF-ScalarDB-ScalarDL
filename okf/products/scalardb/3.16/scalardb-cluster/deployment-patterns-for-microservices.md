...
resource: https://scalardb.scalar-labs.com/docs/3.16/scalardb-cluster/deployment-patterns-for-microservices/
tags:
- scalardb
- v3.16
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.16/scalardb-cluster/deployment-patterns-for-microservices.mdx
...
![ScalarDB Cluster deployment patterns for microservices.](https://scalardb.scalar-labs.com/docs/3.16/scalardb-cluster/images/scalardb-deployment-patterns.png)
