---
type: Tutorial
title: Getting Started with ScalarDB Cluster via .NET
description: This tutorial describes how to create a sample application that uses ScalarDB Cluster through the .NET API.
resource: https://scalardb.scalar-labs.com/docs/3.16/scalardb-cluster/getting-started-with-scalardb-cluster-dotnet/
tags:
- scalardb
- v3.16
- phase:implement
...
doc_id: scalardb-cluster/getting-started-with-scalardb-cluster-dotnet
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.16/scalardb-cluster/getting-started-with-scalardb-cluster-dotnet.mdx
...
This tutorial describes how to create a sample application that uses [ScalarDB Cluster](./section-home.md) through the .NET API.
