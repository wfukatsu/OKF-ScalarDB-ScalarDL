...
title: ScalarDB 3.16 — Scalardb Cluster
description: Directory listing for the `scalardb-cluster` section of the ScalarDB 3.16 documentation.
resource: https://scalardb.scalar-labs.com/docs/3.16/scalardb-cluster/
tags:
- scalardb
- v3.16
- index
...
ScalarDB 3.16 documentation under `scalardb-cluster/`.
...
- [Authenticate and Authorize Users](./scalardb-auth-with-sql.md) — ScalarDB Cluster has a mechanism to authenticate and authorize users.
