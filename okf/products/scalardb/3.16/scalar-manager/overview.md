...
resource: https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/overview/
tags:
- scalardb
- v3.16
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.16/scalar-manager/overview.mdx
...
![dashboard-cluster](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/dashboard-cluster.png)
![dashboard-pod-list](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/dashboard-pod-list.png)

With the Grafana dashboards, you can also view pod logs and metrics in real-time or in time series.

![logs](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/logs.png)
![metrics](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/metrics2.png)
...
![create-pauses](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/backup-and-restore-create-pauses.png)
![check-pauses](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/backup-and-restore-check-pauses.png)
