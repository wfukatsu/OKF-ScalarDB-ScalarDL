...
resource: https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/how-to-use-scalar-manager/
tags:
- scalardb
- v3.16
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.16/scalar-manager/how-to-use-scalar-manager.mdx
...
![login-page](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/login-page.png)
...
![my-profile-page](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/my-profile.png)
...
![user-create-page](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/user-create.png)
...
![edit-user-page](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/edit-user.png)
...
![delete-user-page](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/delete-user.png)
...
![release-detail-page](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/release-detail.png)
...
![grafana-dashboard](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/metrics.png)
...
![grafana-logs-dashboard](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/logs.png)
...
![execute-pause-page](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/execute-pause.png)
...
![schedule-pause-popup](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/schedule-pause-popup.png)
...
![schedule-pauses-page](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/schedule-pauses.png)
...
![check-pauses-page](https://scalardb.scalar-labs.com/docs/3.16/scalar-manager/images/check-pauses.png)
