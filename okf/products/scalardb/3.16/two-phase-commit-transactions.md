...
resource: https://scalardb.scalar-labs.com/docs/3.16/two-phase-commit-transactions/
tags:
- scalardb
- v3.16
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.16/two-phase-commit-transactions.mdx
...
![Sequence diagram for transactions with a two-phase commit interface](https://scalardb.scalar-labs.com/docs/3.16/images/two_phase_commit_sequence_diagram.png)
...
![Load balancing for transactions with a two-phase commit interface](https://scalardb.scalar-labs.com/docs/3.16/images/two_phase_commit_load_balancing.png)
