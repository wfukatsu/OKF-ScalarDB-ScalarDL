...
resource: https://scalardb.scalar-labs.com/docs/3.16/database-adapters/
tags:
- scalardb
- v3.16
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.16/database-adapters.mdx
...
The JDBC adapter supports relational databases through JDBC connections. The following databases are supported: MySQL, MariaDB, PostgreSQL, YugabyteDB, Amazon Aurora (MySQL-compatible and PostgreSQL-compatible), Oracle Database, SQL Server, IBM Db2, and SQLite.
...
| ScalarDB | MySQL, MariaDB | PostgreSQL, YugabyteDB | Oracle | SQL Server | Db2 | SQLite |
|----------|----------------------|------------------------|--------|------------|-----|--------|
