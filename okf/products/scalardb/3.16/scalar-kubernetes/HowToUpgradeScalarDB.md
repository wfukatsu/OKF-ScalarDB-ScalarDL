...
resource: https://scalardb.scalar-labs.com/docs/3.16/scalar-kubernetes/HowToUpgradeScalarDB/
tags:
- scalardb
- v3.16
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.16/scalar-kubernetes/HowToUpgradeScalarDB.mdx
...
The method for upgrading to a patch version is the same as for upgrading to a minor version. For details on how to upgrade, see the [Upgrade to a minor version](https://scalardb.scalar-labs.com/docs/3.16/scalar-kubernetes/?versions=upgrade-minor-version) tab.
