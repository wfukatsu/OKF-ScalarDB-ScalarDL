...
title: Set up a database for ScalarDB/ScalarDL deployment on AWS
description: This guide explains how to set up a database for ScalarDB/ScalarDL deployment on AWS.
resource: https://scalardb.scalar-labs.com/docs/3.16/scalar-kubernetes/SetupDatabaseForAWS/
tags:
- scalardb
- v3.16
- phase:operate
...
doc_id: scalar-kubernetes/SetupDatabaseForAWS
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.16/scalar-kubernetes/SetupDatabaseForAWS.mdx
