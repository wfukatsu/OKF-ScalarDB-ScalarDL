...
title: Guidelines for creating an AKS cluster for ScalarDL Ledger
description: This document explains the requirements and recommendations for creating an Azure Kubernetes Service (AKS) cluster for ScalarDL Ledger deployment. For details on how to deploy ScalarDL Ledger on an AKS cluster, see Deploy ScalarDL Ledger...
resource: https://scalardb.scalar-labs.com/docs/3.16/scalar-kubernetes/CreateAKSClusterForScalarDL/
tags:
- scalardb
- v3.16
- phase:operate
...
doc_id: scalar-kubernetes/CreateAKSClusterForScalarDL
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.16/scalar-kubernetes/CreateAKSClusterForScalarDL.mdx
