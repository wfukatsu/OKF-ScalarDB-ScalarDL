...
resource: https://scalardb.scalar-labs.com/docs/3.16/requirements/
tags:
- scalardb
- v3.16
- phase:design
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/4fa644f40396f8d8f5d3d0d90c217b77ea0e70d1/versioned_docs/version-3.16/requirements.mdx
...
- 60053 (Administrative API / Transaction API / SQL API / pause operation)
- 8080 (GraphQL)
- 9080 (metrics)
...
- **[Oracle JDK](https://www.oracle.com/java/):** 21 (LTS versions)
- **OpenJDK distribution ([Eclipse Temurin](https://adoptium.net/temurin/), [Amazon Corretto](https://aws.amazon.com/corretto/), or [Microsoft Build of OpenJDK](https://learn.microsoft.com/en-us/java/openjdk/)):** 21 (LTS versions)
