...
resource: https://scalardb.scalar-labs.com/docs/3.16/helm-charts/getting-started-monitoring/
tags:
- scalardb
- v3.16
- phase:operate
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/dc5c112650d1543275b5c9de1bf3d1dd6d2d777a/versioned_docs/version-3.16/helm-charts/getting-started-monitoring.mdx
...
1. Save the sample file [scalar-prometheus-custom-values.yaml](https://scalardb.scalar-labs.com/docs/3.16/helm-charts/conf/scalar-prometheus-custom-values.yaml) for `kube-prometheus-stack`.
