...
resource: https://scalardb.scalar-labs.com/docs/3.16/data-modeling/
tags:
- scalardb
- v3.16
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.16/data-modeling.mdx
...
![ScalarDB data model](https://scalardb.scalar-labs.com/docs/3.16/images/scalardb_data_model.png)
...
A column is a fundamental data element and does not need to be broken down any further. Each record is composed of one or more columns. Each column has a data type. For details about the data type, refer to [Database Adapters](./database-adapters.md).
