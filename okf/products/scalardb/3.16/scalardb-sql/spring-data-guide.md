...
resource: https://scalardb.scalar-labs.com/docs/3.16/scalardb-sql/spring-data-guide/
tags:
- scalardb
- v3.16
- phase:implement
...
sources:
- id: docs-scalardb
  resource: https://github.com/scalar-labs/docs-scalardb/blob/6126dfe2f56389351d88b134752618641f9771dd/versioned_docs/version-3.16/scalardb-sql/spring-data-guide.mdx
...
![Rough overall architecture of Spring Data JDBC for ScalarDB](https://scalardb.scalar-labs.com/docs/3.16/scalardb-sql/images/spring_data_ingegration_overall_arch.png)
...
- [Javadoc for Spring Data JDBC for ScalarDB](https://javadoc.io/doc/com.scalar-labs/scalardb-sql-spring-data/3.16.6/index.html)
