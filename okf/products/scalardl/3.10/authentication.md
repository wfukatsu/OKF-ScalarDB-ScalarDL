...
description: This document explains the ScalarDL authentication mechanism and how to use it properly.
resource: https://scalardl.scalar-labs.com/docs/3.10/authentication/
tags:
- scalardl
- v3.10
- phase:implement
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/eecc7f890d648a2f4ff33d60e5a96d57a1aa74d4/versioned_docs/version-3.10/authentication.mdx
...
Note that Ledger authentication and Auditor authentication are only used in the Auditor mode. For more details about Auditor, see [Run a ScalarDL Application Through ScalarDL Ledger and Auditor](./how-to-run-applications-with-auditor.md) and [ScalarDL Implementation](./implementation.md).
...
This section explains what variables you need to configure to use ScalarDL authentication properly. For details about each variable, see [Javadoc](./javadoc/section-home.md).
...
* See [this](./ca/caclient-getting-started.md#get-a-certificate-from-a-ca-server) for how to get a certificate.
