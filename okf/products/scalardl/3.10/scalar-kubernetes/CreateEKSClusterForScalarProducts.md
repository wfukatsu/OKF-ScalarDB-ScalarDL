...
title: Guidelines for creating an Amazon EKS cluster for Scalar products
description: 'To create an Amazon Elastic Kubernetes Service (EKS) cluster for Scalar products, refer to the following:'
resource: https://scalardl.scalar-labs.com/docs/3.10/scalar-kubernetes/CreateEKSClusterForScalarProducts/
tags:
- scalardl
- v3.10
- phase:operate
...
doc_id: scalar-kubernetes/CreateEKSClusterForScalarProducts
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/c1dbc91f4c36ec4ce63e7181302c89b7b6669e62/versioned_docs/version-3.10/scalar-kubernetes/CreateEKSClusterForScalarProducts.mdx
