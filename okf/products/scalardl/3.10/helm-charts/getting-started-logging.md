...
resource: https://scalardl.scalar-labs.com/docs/3.10/helm-charts/getting-started-logging/
tags:
- scalardl
- v3.10
- phase:operate
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/eecc7f890d648a2f4ff33d60e5a96d57a1aa74d4/versioned_docs/version-3.10/helm-charts/getting-started-logging.mdx
...
1. Get the sample file [scalar-loki-stack-custom-values.yaml](https://scalardl.scalar-labs.com/docs/3.10/helm-charts/conf/scalar-loki-stack-custom-values.yaml) for the `loki-stack` helm chart.
