...
resource: https://scalardl.scalar-labs.com/docs/3.10/helm-charts/getting-started-monitoring/
tags:
- scalardl
- v3.10
- phase:operate
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/c1dbc91f4c36ec4ce63e7181302c89b7b6669e62/versioned_docs/version-3.10/helm-charts/getting-started-monitoring.mdx
...
1. Save the sample file [scalar-prometheus-custom-values.yaml](https://scalardl.scalar-labs.com/docs/3.10/helm-charts/conf/scalar-prometheus-custom-values.yaml) for `kube-prometheus-stack`.
