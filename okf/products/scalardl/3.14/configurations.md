...
resource: https://scalardl.scalar-labs.com/docs/latest/configurations/
tags:
- scalardl
- v3.14
- phase:implement
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/03da04b21c1a7ce3eb94d9e29129a0ce194ecbeb/docs/configurations.mdx
...
- **Description:** The master switch for purging residual transaction state (Coordinator state records and request proofs). While this is set to `false`, no state is purged and manual purge requests are rejected. For more details, see [Purge Residual Transaction State](./purge-residual-transaction-state.md).
- **Default value:** `false` (Optional)
