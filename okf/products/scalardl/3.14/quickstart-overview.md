...
resource: https://scalardl.scalar-labs.com/docs/latest/quickstart-overview/
tags:
- scalardl
- v3.14
- phase:implement
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/65cde245dc475500d48ccf7a4d460a7965759c95/docs/quickstart-overview.mdx
