...
resource: https://scalardl.scalar-labs.com/docs/latest/helm-charts/getting-started-logging/
tags:
- scalardl
- v3.13
- phase:operate
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/c1dbc91f4c36ec4ce63e7181302c89b7b6669e62/docs/helm-charts/getting-started-logging.mdx
...
1. Get the sample file [scalar-loki-stack-custom-values.yaml](https://scalardl.scalar-labs.com/docs/latest/helm-charts/conf/scalar-loki-stack-custom-values.yaml) for the `loki-stack` helm chart.
