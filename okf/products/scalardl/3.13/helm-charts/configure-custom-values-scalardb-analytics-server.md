...
resource: https://scalardl.scalar-labs.com/docs/latest/helm-charts/configure-custom-values-scalardb-analytics-server/
tags:
- scalardl
- v3.13
- phase:operate
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/eecc7f890d648a2f4ff33d60e5a96d57a1aa74d4/docs/helm-charts/configure-custom-values-scalardb-analytics-server.mdx
