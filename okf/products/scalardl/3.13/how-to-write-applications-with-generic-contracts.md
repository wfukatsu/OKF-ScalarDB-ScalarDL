...
resource: https://scalardl.scalar-labs.com/docs/3.13/how-to-write-applications-with-generic-contracts/
tags:
- scalardl
- v3.13
- phase:implement
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/03da04b21c1a7ce3eb94d9e29129a0ce194ecbeb/versioned_docs/version-3.13/how-to-write-applications-with-generic-contracts.mdx
...
The Client SDK APIs for generic contracts are provided by a service class called [`GenericContractClientService`](https://javadoc.io/static/com.scalar-labs/scalardl-java-client-sdk/3.13.0/com/scalar/dl/client/service/GenericContractClientService.html). The following is a code snippet that shows how to use `GenericContractClientService` to execute a contract.
