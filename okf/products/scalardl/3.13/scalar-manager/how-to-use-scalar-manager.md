...
resource: https://scalardl.scalar-labs.com/docs/latest/scalar-manager/how-to-use-scalar-manager/
tags:
- scalardl
- v3.13
- phase:operate
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/c1dbc91f4c36ec4ce63e7181302c89b7b6669e62/docs/scalar-manager/how-to-use-scalar-manager.mdx
...
![login-page](https://scalardl.scalar-labs.com/docs/latest/scalar-manager/images/login-page.png)
...
![my-profile-page](https://scalardl.scalar-labs.com/docs/latest/scalar-manager/images/my-profile.png)
...
![user-create-page](https://scalardl.scalar-labs.com/docs/latest/scalar-manager/images/user-create.png)
...
![edit-user-page](https://scalardl.scalar-labs.com/docs/latest/scalar-manager/images/edit-user.png)
...
![delete-user-page](https://scalardl.scalar-labs.com/docs/latest/scalar-manager/images/delete-user.png)
...
![release-detail-page](https://scalardl.scalar-labs.com/docs/latest/scalar-manager/images/release-detail.png)
...
![grafana-dashboard](https://scalardl.scalar-labs.com/docs/latest/scalar-manager/images/metrics.png)
...
![grafana-logs-dashboard](https://scalardl.scalar-labs.com/docs/latest/scalar-manager/images/logs.png)
...
![execute-pause-page](https://scalardl.scalar-labs.com/docs/latest/scalar-manager/images/execute-pause.png)
...
![schedule-pause-popup](https://scalardl.scalar-labs.com/docs/latest/scalar-manager/images/schedule-pause-popup.png)
...
![schedule-pauses-page](https://scalardl.scalar-labs.com/docs/latest/scalar-manager/images/schedule-pauses.png)
...
![check-pauses-page](https://scalardl.scalar-labs.com/docs/latest/scalar-manager/images/check-pauses.png)
