...
resource: https://scalardl.scalar-labs.com/docs/3.11/helm-charts/configure-custom-values-scalar-admin-for-kubernetes/
tags:
- scalardl
- v3.11
- phase:operate
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/eecc7f890d648a2f4ff33d60e5a96d57a1aa74d4/versioned_docs/version-3.11/helm-charts/configure-custom-values-scalar-admin-for-kubernetes.mdx
