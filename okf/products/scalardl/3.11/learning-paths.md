---
type: Concept
title: ScalarDL Learning Paths
description: This guide provides learning paths for different roles. Depending on your role, follow the appropriate sequence of documents to gain a comprehensive understanding of ScalarDL.
resource: https://scalardl.scalar-labs.com/docs/3.11/learning-paths/
tags:
- scalardl
- v3.11
- phase:design
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/eecc7f890d648a2f4ff33d60e5a96d57a1aa74d4/versioned_docs/version-3.11/learning-paths.mdx
...
- [About ScalarDL category](./overview.md)
