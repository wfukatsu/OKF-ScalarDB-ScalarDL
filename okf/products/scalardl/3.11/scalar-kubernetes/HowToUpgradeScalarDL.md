...
resource: https://scalardl.scalar-labs.com/docs/3.11/scalar-kubernetes/HowToUpgradeScalarDL/
tags:
- scalardl
- v3.11
- phase:operate
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/eecc7f890d648a2f4ff33d60e5a96d57a1aa74d4/versioned_docs/version-3.11/scalar-kubernetes/HowToUpgradeScalarDL.mdx
...
The method for upgrading to a patch version is the same as for upgrading to a minor version. For details on how to upgrade, see the [Upgrade to a minor version](https://scalardl.scalar-labs.com/docs/3.11/scalar-kubernetes/?versions=upgrade-minor-version) tab.
