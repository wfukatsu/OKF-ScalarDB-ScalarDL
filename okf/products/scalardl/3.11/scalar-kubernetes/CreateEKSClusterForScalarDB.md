...
title: (Deprecated) Guidelines for creating an EKS cluster for ScalarDB Server
description: ScalarDB Server is now deprecated. Please use ScalarDB Cluster instead.
resource: https://scalardl.scalar-labs.com/docs/3.11/scalar-kubernetes/CreateEKSClusterForScalarDB/
tags:
- scalardl
- v3.11
- phase:operate
...
doc_id: scalar-kubernetes/CreateEKSClusterForScalarDB
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/eecc7f890d648a2f4ff33d60e5a96d57a1aa74d4/versioned_docs/version-3.11/scalar-kubernetes/CreateEKSClusterForScalarDB.mdx
