...
title: A Guide on How to Backup and Restore Data in ScalarDL
description: Since ScalarDL uses ScalarDB that provides transaction capability on top of non-transactional (possibly transactional) databases non-invasively, you need to take special care of backing up and restoring the databases in a...
resource: https://scalardl.scalar-labs.com/docs/3.11/backup-restore/
tags:
- scalardl
- v3.11
- phase:operate
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/c1dbc91f4c36ec4ce63e7181302c89b7b6669e62/versioned_docs/version-3.11/backup-restore.mdx
