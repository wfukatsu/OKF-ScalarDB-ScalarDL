...
resource: https://scalardl.scalar-labs.com/docs/3.11/scalar-manager/overview/
tags:
- scalardl
- v3.11
- phase:operate
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/eecc7f890d648a2f4ff33d60e5a96d57a1aa74d4/versioned_docs/version-3.11/scalar-manager/overview.mdx
...
![dashboard-cluster](https://scalardl.scalar-labs.com/docs/3.11/scalar-manager/images/dashboard-cluster.png)
![dashboard-pod-list](https://scalardl.scalar-labs.com/docs/3.11/scalar-manager/images/dashboard-pod-list.png)

With the Grafana dashboards, you can also view pod logs and metrics in real-time or in time series.

![logs](https://scalardl.scalar-labs.com/docs/3.11/scalar-manager/images/logs.png)
![metrics](https://scalardl.scalar-labs.com/docs/3.11/scalar-manager/images/metrics2.png)
...
![create-pauses](https://scalardl.scalar-labs.com/docs/3.11/scalar-manager/images/backup-and-restore-create-pauses.png)
![check-pauses](https://scalardl.scalar-labs.com/docs/3.11/scalar-manager/images/backup-and-restore-check-pauses.png)
