...
resource: https://scalardl.scalar-labs.com/docs/3.12/how-to-write-applications/
tags:
- scalardl
- v3.12
- phase:implement
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/eecc7f890d648a2f4ff33d60e5a96d57a1aa74d4/versioned_docs/version-3.12/how-to-write-applications.mdx
...
The Java Client SDK APIs are provided by a service class called [`ClientService`](https://javadoc.io/static/com.scalar-labs/scalardl-java-client-sdk/3.12.3/com/scalar/dl/client/service/ClientService.html). The following is a code snippet that shows how to use `ClientService` to execute a contract.
...
For more details, see [`StatusCode`](https://javadoc.io/static/com.scalar-labs/scalardl-common/3.12.3/com/scalar/dl/ledger/service/StatusCode.html).
...
You can get [`AssetProof`](https://javadoc.io/static/com.scalar-labs/scalardl-common/3.12.3/com/scalar/dl/ledger/asset/AssetProof.html) from the result [`ContractExecutionResult`](https://javadoc.io/static/com.scalar-labs/scalardl-common/3.12.3/com/scalar/dl/ledger/model/ContractExecutionResult.html) of the `executeContract` method of the Client SDK. An Asset Proof can be validated if it is not tampered and it is from Ledger by verifying the signature.
