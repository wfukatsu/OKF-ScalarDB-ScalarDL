...
resource: https://scalardl.scalar-labs.com/docs/3.12/scalar-manager/overview/
tags:
- scalardl
- v3.12
- phase:operate
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/c1dbc91f4c36ec4ce63e7181302c89b7b6669e62/versioned_docs/version-3.12/scalar-manager/overview.mdx
...
![dashboard-cluster](https://scalardl.scalar-labs.com/docs/3.12/scalar-manager/images/dashboard-cluster.png)
![dashboard-pod-list](https://scalardl.scalar-labs.com/docs/3.12/scalar-manager/images/dashboard-pod-list.png)

With the Grafana dashboards, you can also view pod logs and metrics in real-time or in time series.

![logs](https://scalardl.scalar-labs.com/docs/3.12/scalar-manager/images/logs.png)
![metrics](https://scalardl.scalar-labs.com/docs/3.12/scalar-manager/images/metrics2.png)
...
![create-pauses](https://scalardl.scalar-labs.com/docs/3.12/scalar-manager/images/backup-and-restore-create-pauses.png)
![check-pauses](https://scalardl.scalar-labs.com/docs/3.12/scalar-manager/images/backup-and-restore-check-pauses.png)
