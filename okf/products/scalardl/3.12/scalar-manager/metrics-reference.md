...
description: This document provides a list of explanations for all metrics available in Scalar Manager, via Grafana, to help you monitor the performance, health, and operational status of your ScalarDL deployments.
resource: https://scalardl.scalar-labs.com/docs/3.12/scalar-manager/metrics-reference/
tags:
- scalardl
- v3.12
- phase:operate
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/c1dbc91f4c36ec4ce63e7181302c89b7b6669e62/versioned_docs/version-3.12/scalar-manager/metrics-reference.mdx
