...
resource: https://scalardl.scalar-labs.com/docs/3.12/scalar-kubernetes/HowToUpgradeScalarDL/
tags:
- scalardl
- v3.12
- phase:operate
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/c1dbc91f4c36ec4ce63e7181302c89b7b6669e62/versioned_docs/version-3.12/scalar-kubernetes/HowToUpgradeScalarDL.mdx
...
The method for upgrading to a patch version is the same as for upgrading to a minor version. For details on how to upgrade, see the [Upgrade to a minor version](https://scalardl.scalar-labs.com/docs/3.12/scalar-kubernetes/?versions=upgrade-minor-version) tab.
