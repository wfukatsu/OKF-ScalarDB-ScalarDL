...
title: Make ScalarDB or ScalarDL deployed in a Kubernetes cluster environment available from applications
description: This document explains how to make ScalarDB or ScalarDL deployed in a Kubernetes cluster environment available from applications. To make ScalarDB or ScalarDL available from applications, you can use Scalar Envoy via a Kubernetes service...
resource: https://scalardl.scalar-labs.com/docs/3.12/scalar-kubernetes/AccessScalarProducts/
tags:
- scalardl
- v3.12
- phase:operate
...
doc_id: scalar-kubernetes/AccessScalarProducts
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/eecc7f890d648a2f4ff33d60e5a96d57a1aa74d4/versioned_docs/version-3.12/scalar-kubernetes/AccessScalarProducts.mdx
...
For more details on how to configure your custom values file, see [Service configurations](../helm-charts/configure-custom-values-envoy.md#service-configurations).
