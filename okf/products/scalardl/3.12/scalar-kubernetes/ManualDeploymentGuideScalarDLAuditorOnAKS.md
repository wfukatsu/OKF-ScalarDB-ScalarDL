...
title: Deploy ScalarDL Ledger and ScalarDL Auditor on Azure Kubernetes Service (AKS)
description: This guide explains how to deploy ScalarDL Ledger and ScalarDL Auditor on Azure Kubernetes Service (AKS).
resource: https://scalardl.scalar-labs.com/docs/3.12/scalar-kubernetes/ManualDeploymentGuideScalarDLAuditorOnAKS/
tags:
- scalardl
- v3.12
- phase:operate
...
doc_id: scalar-kubernetes/ManualDeploymentGuideScalarDLAuditorOnAKS
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/eecc7f890d648a2f4ff33d60e5a96d57a1aa74d4/versioned_docs/version-3.12/scalar-kubernetes/ManualDeploymentGuideScalarDLAuditorOnAKS.mdx
...
* Use different Azure accounts (most recommended way)
  ...
  ![image](https://scalardl.scalar-labs.com/docs/3.12/scalar-kubernetes/images/png/AKS_ScalarDL_Auditor_Multi_Account.drawio.png)

* Use different Azure Virtual Networks (VNets) (second recommended way)

  ![image](https://scalardl.scalar-labs.com/docs/3.12/scalar-kubernetes/images/png/AKS_ScalarDL_Auditor_Multi_VNet.drawio.png)

* Use different namespaces (third recommended way)

  ![image](https://scalardl.scalar-labs.com/docs/3.12/scalar-kubernetes/images/png/AKS_ScalarDL_Auditor_Multi_Namespace.drawio.png)
...
You must get the ScalarDL Ledger and ScalarDL Auditor container images. For details, see [How to get the container images of Scalar products](./HowToGetContainerImages.md).
...
Deploy ScalarDL Ledger on your AKS cluster by using the Helm Chart for ScalarDL Ledger. For details, see [Deploy Scalar products using Scalar Helm Charts](../helm-charts/how-to-deploy-scalar-products.md).
...
Deploy ScalarDL Auditor on your AKS cluster by using the Helm Chart for ScalarDL Auditor. For details, see [Deploy Scalar products using Scalar Helm Charts](../helm-charts/how-to-deploy-scalar-products.md).
