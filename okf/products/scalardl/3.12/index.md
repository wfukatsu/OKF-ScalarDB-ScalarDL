...
title: ScalarDL 3.12
description: Documentation set for ScalarDL 3.12 (newest patch 3.12.3).
resource: https://scalardl.scalar-labs.com/docs/3.12/
tags:
- scalardl
- v3.12
- product-version
...
| Newest patch release described | 3.12.3 |
| Docs site | https://scalardl.scalar-labs.com/docs/3.12/ |
| Upstream source | https://github.com/scalar-labs/docs-scalardl @ `eecc7f890d64` |
| Concepts in this version | 141 |
...
- [ScalarDL 3.12 Release Notes](./releases/release-notes.md)
