...
resource: https://scalardl.scalar-labs.com/docs/3.12/helm-charts/getting-started-scalardb-cluster-tls-cert-manager/
tags:
- scalardl
- v3.12
- phase:operate
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/eecc7f890d648a2f4ff33d60e5a96d57a1aa74d4/versioned_docs/version-3.12/helm-charts/getting-started-scalardb-cluster-tls-cert-manager.mdx
...
1. Set your license key and certificate as environment variables. If you don't have a license key, please [contact us](https://www.scalar-labs.com/contact). For details about the value of `<CERT_PEM_FOR_YOUR_LICENSE_KEY>`, see [How to Configure a License Key](https://scalardl.scalar-labs.com/docs/3.12/scalar-licensing/index/).
