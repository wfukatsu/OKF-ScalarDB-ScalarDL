...
resource: https://scalardl.scalar-labs.com/docs/3.12/helm-charts/getting-started-monitoring/
tags:
- scalardl
- v3.12
- phase:operate
...
sources:
- id: docs-scalardl
  resource: https://github.com/scalar-labs/docs-scalardl/blob/eecc7f890d648a2f4ff33d60e5a96d57a1aa74d4/versioned_docs/version-3.12/helm-charts/getting-started-monitoring.mdx
...
1. Save the sample file [scalar-prometheus-custom-values.yaml](https://scalardl.scalar-labs.com/docs/3.12/helm-charts/conf/scalar-prometheus-custom-values.yaml) for `kube-prometheus-stack`.
